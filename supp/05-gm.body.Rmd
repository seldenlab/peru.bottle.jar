...
```{r gpa.b, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
...
```{r box1.b, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap = "Boxplot of centroid size by spatial/temporal unit."}
...
```{r gmpca.b, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# principal components analysis
...
```{r min.max.body, echo=TRUE, out.width = "100%", dpi = 300, warning=FALSE}
...
```{r pca.warp.bo, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Results of PCA summarising shape variation in bottle bodies, gray; and jar bodies, orange; with shapes + warp grids for maxima/minima of each axis."}
# pca warp body                 
knitr::include_graphics('images/pca-warp-body.jpg')
```
...
```{r def.mod.1.b, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
