 ...
 * Bottle and jar necks **differ significantly** in shape
 * Bottle and jar necks do not differ in size
 
```{r pca.warp.ne.index, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Results of PCA summarising shape variation in bottle necks, gray; and jar necks, orange; with shapes + warp grids for maxima/minima of each axis."}
# pca warp neck                   
knitr::include_graphics('images/pca-warp-neck.jpg')
```
```{r botjarneck, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Mean shapes for bottle necks (a), jar necks (b), and comparison of bottle (gray) and jar (black) neck shapes (c)."}
knitr::include_graphics('images/mshape-neck.png')
```

**Basal morphology**:

 * Bottle and jar bases **differ significantly** in shape
 * Bottle and jar bases do not differ in size
 
```{r pca.warp.ba.index, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Results of PCA summarising shape variation in bottle bases, gray; and jar bases, orange; with shapes + warp grids for maxima/minima of each axis."}
# pca warp                   
knitr::include_graphics('images/pca-warp-base.jpg')
```
```{r botjarbase.index, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Mean shapes for bottle bases (a), jar bases (b), and comparison of bottle (gray) and jar (black) base shapes (c)."}
