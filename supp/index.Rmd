...
```{r botjar, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE, fig.cap="Mean shapes for bottles (a), jars (c), and comparison of bottle (gray) and jar (black) shape (b)."}
...
```{r botjarneck, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE, fig.cap="Mean shapes for bottle necks (a), jar necks (b), and comparison of bottle (gray) and jar (black) neck shapes (c)."}
knitr::include_graphics('images/mshape-neck.png')
```

**Body morphology**:

 * Bottle and jar bodies **differ significantly** in shape
 * Bottle and jar bodies do not differ in size
