...
```{r allometry.1, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# allometry: shape as a function of vessel size?
fit.size<-procD.lm(shape ~ size, 
                   data = gdf, 
                   print.progress = FALSE, 
                   iter = 9999)

# Procrustes ANOVA: does shape change with size?
anova(fit.size)
```


```{r common.allometry.1, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# common allometries
fit.common<-procD.lm(shape ~ size + type, 
                     data = gdf, 
                     print.progress = FALSE, 
                     iter = 9999)
...
common.allometry <- plot(fit.size,
                         type = "regression",
                         reg.type = "RegScore",
...
```{r unique.allometry.1, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# unique allometries
fit.unique<-procD.lm(shape ~ size * type, 
                     data = gdf, 
                     print.progress = FALSE, 
                     iter = 9999)
...
# do vessel forms express parallel, convergent, or divergent morphological characteristics?
...
```{r disparity, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
