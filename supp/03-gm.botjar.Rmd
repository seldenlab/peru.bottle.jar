...
```{r min.max.botjar, echo=TRUE, out.width = "100%", dpi = 300, warning=FALSE}
...
```{r pca.warp.botjar, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Results of PCA summarising shape variation in bottles, gray; and jars, orange; with shapes + warp grids for maxima/minima of each axis."}
# pca warp                   
