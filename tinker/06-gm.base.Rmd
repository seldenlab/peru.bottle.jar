...
```{r min.max.base, echo=TRUE, out.width = "100%", dpi = 300, warning=FALSE}
...
```{r pca.warp.ba, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Results of PCA summarising shape variation in bottles, gray; and jars, orange; with shapes + warp grids for maxima/minima of each axis."}
# pca warp                   
...
# base shape as a function of vessel form?
...
```{r mshape.ba, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Mean shapes for bottle bases (a), jar bases (b), and comparison of bottle (gray) and jar (black) base shapes (c)."}
